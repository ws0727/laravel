...
<![endif]-->
<link href="/laravel/blog/public/static/hui/static/h-ui/css/H-ui.min.css" rel="stylesheet" type="text/css" />
<link href="/laravel/blog/public/static/hui/static/h-ui.admin/css/H-ui.login.css" rel="stylesheet" type="text/css" />
<link href="/laravel/blog/public/static/hui/static/h-ui.admin/css/style.css" rel="stylesheet" type="text/css" />
<link href="/laravel/blog/public/static/hui/lib/Hui-iconfont/1.0.8/iconfont.css" rel="stylesheet" type="text/css" />
<!--[if IE 6]>
         ...
         function login() {
            ...
            $.ajax({
            	...
            	success:function (res) {
            		console.log(res)
            		if (res.status=='ok') {
            		  location.href='<?php echo url("show/index") ?>' 	
            		}
            	}
            })
         }
